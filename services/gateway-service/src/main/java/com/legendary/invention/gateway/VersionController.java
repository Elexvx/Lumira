...
public class VersionController {
    ...
    @GetMapping({"/api/version", "/api/v1/version", "/api/v1/gateway/version"})
    public ApiResponse<ServiceVersionInfo> version(ServerWebExchange exchange) {
        return ApiResponse.success(current(), null, exchange.getRequest().getPath().value());
    }
