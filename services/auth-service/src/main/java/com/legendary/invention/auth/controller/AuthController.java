...
import com.legendary.invention.auth.service.PasskeyAuthService;
...
public class AuthController {
    ...
    @GetMapping("/passkeys")
    public ApiResponse<java.util.List<com.legendary.invention.api.system.PasskeyCredentialDTO>> passkeyCredentials() {
