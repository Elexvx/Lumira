...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO `ai_skill` (`id`, `skill_code`, `skill_name`, `category`, `description`, `risk_level`, `read_only`, `need_confirm`, `enabled`, `is_deleted`, `create_time`, `update_time`) VALUES (1,'knowledge.search','知识检索','COMMON','从已授权知识库中查找相关内容并返回参考结论。','LOW',1,0,1,0,'2026-05-15 00:52:27','2026-05-15 00:52:27'),(2,'content.summary','内容总结','COMMON','对文本、列表或对话内容进行结构化摘要。','LOW',1,0,1,0,'2026-05-15 00:52:27','2026-05-15 00:52:27'),(3,'customer.reply','客户回复','CUSTOM','基于上下文生成面向客户的正式回复话术。','MEDIUM',0,0,1,0,'2026-05-15 00:52:27','2026-05-15 00:52:27'),(4,'data.query','数据查询','CUSTOM','访问已授权业务数据并生成查询结果说明。','MEDIUM',0,0,1,0,'2026-05-15 00:52:27','2026-05-15 00:52:27'),(5,'data.export','数据导出','CUSTOM','将查询结果导出为可下载的结构化数据。','HIGH',0,1,1,0,'2026-05-15 00:52:27','2026-05-15 00:52:27'),(6,'workflow.request','流程发起','CUSTOM','发起审批、流转或待办类业务流程。','HIGH',0,1,1,0,'2026-05-15 00:52:27','2026-05-15 00:52:27');
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `evaluation_grade_rule` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `template_id` bigint unsigned NOT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `evaluation_review_record` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `instance_id` bigint unsigned NOT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `evaluation_score_detail` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `evaluation_score_task` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `instance_id` bigint unsigned NOT NULL,
