...
VALUES
    ...
    (-1077, -1068, 'expert.application', '专家申请', 'MENU', '/competitions/expert-apply', '@/pages/competition', 'SolutionOutlined', 2, NULL, 'ENABLED', 0, 0, 0),
    ...
    (-1079, 0, 'certificate.root', '证书管理', 'CATALOG', '/certificates', 'redirect:/certificates/mine', 'FileProtectOutlined', 6, NULL, 'ENABLED', 0, 0, 0),
