...
('DEFAULT','MEMBER_FIELD','memberName','成员姓名','{"fieldType":"TEXT","placeholder":"请输入成员姓名","validationRule":"PERSON_NAME","standardField":true}',NULL,110,1,1,0),
...
VALUES
    ...
    (-1079, 0, 'certificate.root', '证书中心', 'CATALOG', '/certificates', 'redirect:/certificates/mine', 'FileProtectOutlined', 6, NULL, 'ENABLED', 0, 0, 0),
    ...
    (-1081, -1079, 'certificate.generate', '跨赛事证书生成', 'MENU', '/certificates/generate', '@/pages/certificates/GeneratePage', 'FileDoneOutlined', 2, 'aiadc:certificate-batch:create', 'ENABLED', 0, 0, 0),
    (-1082, -1079, 'certificate.records', '全局证书记录', 'MENU', '/certificates/records', '@/pages/certificates/RecordsPage', 'AuditOutlined', 3, 'aiadc:certificate:view', 'ENABLED', 0, 0, 0),
    ...
    (-1078, -1068, 'expert.review.tasks', '跨赛事评审工作台', 'MENU', '/expert-review/reviews', '@/pages/competition/CompetitionReviewPage', 'AuditOutlined', 2, 'review:workbench:view', 'ENABLED', 0, 0, 0),
