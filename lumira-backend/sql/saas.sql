...
CREATE TABLE `payment_builtin_mock_callback` (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sys_plugin_migration_request` (
  ...
  `expected_schema_digest` char(64) DEFAULT NULL,
...
-- The central Migrator records execution facts separately from the mutable
-- request state. A generated nullable key enforces one active execution per
-- request while allowing a later, fenced recovery attempt after failure.
...
-- make drift reviewable without turning the control plane into a schema dump.
...
-- Built-in alerting plugin. MySQL owns durable alert state and delivery attempts;
-- the async runtime only drives the lease-protected worker loop.
CREATE TABLE `alert_channel` (
  ...
  `last_test_error` varchar(1000) DEFAULT NULL,
...
CREATE TABLE `alert_contact_group` (
  ...
  `deleted` tinyint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_alert_contact_group_name` (`name`,`deleted`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE `alert_contact_member` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  ...
  `deleted` tinyint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_alert_contact_member_group` (`contact_group_id`,`deleted`,`enabled`),
  KEY `idx_alert_contact_member_channel` (`channel_id`,`deleted`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `alert_rule` (
  ...
  `pending_seconds` int NOT NULL DEFAULT '300',
  `severity` varchar(16) NOT NULL DEFAULT 'WARNING',
  `contact_group_id` bigint NOT NULL,
  `enabled` tinyint NOT NULL DEFAULT '0',
  `labels_json` json DEFAULT NULL,
  `last_evaluated_at` datetime DEFAULT NULL,
  `evaluation_error` varchar(1000) DEFAULT NULL,
  `version` bigint NOT NULL DEFAULT '1',
  `created_by` bigint NOT NULL DEFAULT '0',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_by` bigint NOT NULL DEFAULT '0',
  ...
  `deleted` tinyint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_alert_rule_due` (`deleted`,`enabled`,`last_evaluated_at`,`id`),
  KEY `idx_alert_rule_contact_group` (`contact_group_id`,`deleted`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `alert_instance` (
  ...
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_alert_instance_rule_status` (`rule_id`,`status`,`id`),
  KEY `idx_alert_instance_status_updated` (`status`,`updated_at`),
  KEY `idx_alert_instance_fingerprint` (`fingerprint`,`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `alert_event` (
  ...
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_alert_event_instance` (`instance_id`,`created_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `alert_delivery` (
  ...
  `provider_message_id` varchar(256) DEFAULT NULL,
  ...
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_alert_delivery_dedupe` (`dedupe_key`),
  KEY `idx_alert_delivery_claim` (`status`,`next_attempt_at`,`claim_until`,`id`),
...
CREATE TABLE `alert_directory_mapping` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `channel_id` bigint NOT NULL,
  `user_id` bigint NOT NULL,
  `user_uuid` char(36) NOT NULL,
  `provider_user_id` varchar(256) NOT NULL,
  `provider_display_name` varchar(128) DEFAULT NULL,
  `match_source` varchar(24) NOT NULL,
...
CREATE TABLE `alert_worker_lease` (
  `lease_name` varchar(64) NOT NULL,
  `owner_id` varchar(128) NOT NULL,
  `lease_until` datetime NOT NULL,
  `heartbeat_at` datetime NOT NULL,
  PRIMARY KEY (`lease_name`),
  KEY `idx_alert_worker_lease_until` (`lease_until`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
-- Configuration governance is database-owned.  Versions are append-only;
-- sys_config remains the current-value store and is never replaced by a
...
CREATE TABLE `competition_award_grant` (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
('DEFAULT','AWARD_SETTINGS','award-rules','获奖设置','{"version":2,"mainQuotaType":"FIXED","mainAwards":[{"awardName":"一等奖","quota":1},{"awardName":"二等奖","quota":2},{"awardName":"三等奖","quota":3}],"excellence":{"enabled":true,"quota":5},"specialAwards":[]}','按评审发布结果的最终排名生成获奖名单。',600,1,1,0),
...
('DEFAULT','PROJECT_FIELD','title','项目名称','{"fieldType":"TEXT","placeholder":"请输入项目名称","validationRule":"DISPLAY_NAME","standardField":true}',NULL,210,1,1,0),
...
CREATE TABLE `aiadc_expert` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `code` varchar(64) NOT NULL,
  `competition_uuid` char(36) DEFAULT NULL,
  ...
  KEY `idx_aiadc_expert_competition` (`competition_uuid`,`deleted`,`updated_at`),
...
VALUES
    ...
    (-956, -1100, 'files.download-center', '下载中心', 'MENU', '/data-management/download-center', '@/pages/files/DownloadCenter', 'DownloadOutlined', 9, 'download:center:view', 'ENABLED', 0, 0, 0),
    (-1100, 0, 'data.management.root', '数据管理', 'CATALOG', '/data-management', '@/pages/DataManagementLandingPage', 'DatabaseOutlined', 3, NULL, 'ENABLED', 0, 0, 0),
    (-1101, -1100, 'data.query-center', '查询中心', 'CATALOG', '/data-management/query-center', 'redirect:/dashboard/home', 'SearchOutlined', 7, NULL, 'DISABLED', 0, 0, 1),
    ...
    (-1053, -1101, 'activity.search', '活动查询', 'MENU', '/activities/search', 'redirect:/activities/management', 'SearchOutlined', 3, 'aiadc:activity:view', 'DISABLED', 0, 0, 1),
    ...
    (-1070, 0, 'competition.root', '赛事', 'CATALOG', '/competitions', 'redirect:/competitions/register', 'TrophyOutlined', 5, NULL, 'DISABLED', 0, 0, 1),
    ...
    (-1075, -1069, 'competition.registration', '赛事报名', 'MENU', '/competitions/register', '@/pages/competition', 'FormOutlined', 1, 'aiadc:registration:view', 'ENABLED', 0, 0, 0),
    (-1076, -1069, 'activity.registration', '活动报名', 'MENU', '/activities/register', '@/pages/competition', 'CalendarOutlined', 2, 'aiadc:activity:create', 'ENABLED', 0, 0, 0),
    (-1113, -1069, 'competition.review-results', '评审结果与申诉', 'MENU', '/competitions/review-results', '@/pages/competition/CompetitionReviewResultsPage', 'FileSearchOutlined', 3, 'review:appeal:submit', 'ENABLED', 0, 0, 0),
    (-1114, -1069, 'certificate.mine', '我的证书', 'MENU', '/certificates/mine', '@/pages/certificates/MyCertificatesPage', 'SafetyCertificateOutlined', 4, NULL, 'ENABLED', 0, 0, 0),
    (-1077, -1068, 'expert.application', '专家申请', 'MENU', '/competitions/expert-apply', '@/pages/competition', 'SolutionOutlined', 3, NULL, 'ENABLED', 0, 0, 0),
    ...
    (-1096, -1101, 'project.search', '项目查询', 'MENU', '/projects/search', 'redirect:/dashboard/home', 'SearchOutlined', 2, 'aiadc:project:view', 'DISABLED', 0, 0, 1),
    (-1093, -1100, 'project.management.create', '新增项目', 'BUTTON', NULL, NULL, NULL, 1, 'aiadc:project:create', 'ENABLED', 0, 0, 0),
    (-1094, -1100, 'project.management.update', '编辑项目', 'BUTTON', NULL, NULL, NULL, 2, 'aiadc:project:update', 'ENABLED', 0, 0, 0),
    (-1095, -1100, 'project.management.delete', '删除项目', 'BUTTON', NULL, NULL, NULL, 3, 'aiadc:project:delete', 'ENABLED', 0, 0, 0),
    (-1110, -1100, 'payment.management', '全局支付流水', 'MENU', '/payments/management', '@/pages/payment', 'CreditCardOutlined', 5, 'payment:order:view', 'ENABLED', 0, 0, 0),
    ...
    (-1060, 0, 'expert.root', '专家库', 'CATALOG', '/experts', 'redirect:/experts/management', 'SolutionOutlined', 7, NULL, 'DISABLED', 0, 0, 1),
    (-1061, -1068, 'expert.management', '专家管理', 'MENU', '/experts/management', '@/pages/expert', 'SolutionOutlined', 1, 'expert:view', 'ENABLED', 0, 0, 0),
    ...
    (-1078, -1068, 'expert.review.tasks', '我的评审', 'MENU', '/expert-review/reviews', '@/pages/competition/CompetitionReviewPage', 'AuditOutlined', 2, 'review:task:view', 'ENABLED', 0, 0, 0),
    ...
    (-958, -1100, 'team.create', '创建团队', 'BUTTON', NULL, NULL, NULL, 1, 'team:create', 'ENABLED', 0, 0, 0),
    (-959, -1100, 'team.update', '编辑团队', 'BUTTON', NULL, NULL, NULL, 2, 'team:update', 'ENABLED', 0, 0, 0),
    (-960, -1100, 'team.delete', '删除团队', 'BUTTON', NULL, NULL, NULL, 3, 'team:delete', 'ENABLED', 0, 0, 0),
    (-961, -1100, 'team.member.view', '查看成员', 'BUTTON', NULL, NULL, NULL, 4, 'team:member:view', 'ENABLED', 0, 0, 0),
    (-962, -1100, 'team.member.invite', 'Invite member', 'BUTTON', NULL, NULL, NULL, 5, 'team:member:invite', 'ENABLED', 0, 0, 0),
    (-963, -1100, 'team.member.remove', '移除成员', 'BUTTON', NULL, NULL, NULL, 6, 'team:member:remove', 'ENABLED', 0, 0, 0),
    (-964, -1100, 'team.member.role-update', '更新成员角色', 'BUTTON', NULL, NULL, NULL, 7, 'team:member:role-update', 'ENABLED', 0, 0, 0),
    (-950, 0, 'user.center.root', '用户中心', 'CATALOG', '/user-center', '@/layouts/SettingsLayout/SettingsLayout', 'TeamOutlined', 18, 'user:center:view', 'ENABLED', 0, 0, 0),
    ...
    (-940, 0, 'user.center.personal', '个人中心', 'CATALOG', '/user-center/personal-center', '@/layouts/SettingsLayout/SettingsLayout', 'IdcardOutlined', 19, 'profile:view', 'ENABLED', 0, 0, 0),
    ...
    (-1000, 0, 'settings.root', '系统设置', 'CATALOG', '/settings', '@/layouts/SettingsLayout/SettingsLayout', 'SettingOutlined', 20, 'system:view', 'ENABLED', 0, 0, 0),
...
VALUES
    ...
    ('BRANDING','branding.maintenance-mode-enabled','false',140,'ENABLED',0,0,0),
    ...
    ('CERTIFICATE','certificate.rule.record-statuses','GENERATING,ISSUED,FAILED,REVOKED',130,'ENABLED',0,0,0),
...
-- Seed metadata for every current sys_config row so the first governed write
-- has a complete owner/type/sensitivity/refresh contract even on a fresh DB.
