...
public class PluginSecurityConfig {
    ...
    public PluginSecurityConfig(
            TraceIdFilter traceIdFilter,
            InternalServiceTokenAuthFilter internalServiceTokenAuthFilter,
            PluginJwtAuthFilter pluginJwtAuthFilter,
    ...
    @Bean
    public SecurityFilterChain pluginSecurityFilterChain(HttpSecurity http, SecurityProperties securityProperties) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .addFilterAfter(pluginJwtAuthFilter, InternalServiceTokenAuthFilter.class);
        return http.build();
    }
