...
class PluginServiceApplicationYamlTest {

    @Test
    void standalonePluginServiceBridgesSharedDeploymentEnvNames() {
        Properties properties = loadApplicationProperties();

        assertThat(properties.getProperty("spring.application.name")).isEqualTo("plugin-service");
        ...
        assertThat(properties.getProperty("saas.security.permit-paths[6]")).isEqualTo("/api/v2/plugins/readiness");
        assertThat(properties.getProperty("saas.security.permit-paths[7]")).isEqualTo("/api/v2/plugins/health");
        assertThat(properties.getProperty("saas.security.permit-paths[8]")).isEqualTo("/api/v2/plugins/metrics");
