...
class PluginJwtAuthFilterTest {
    ...
    void shouldPreserveExistingInternalAuthenticationWhenAuthorizationHeaderIsPresent() throws Exception {
        ...
        PluginJwtAuthFilter filter = new PluginJwtAuthFilter(jwtTokenService, authInternalApi);
        ...
        MockHttpServletRequest request = new MockHttpServletRequest("POST", "/plugin/internal/jobs/outbox/relay");
