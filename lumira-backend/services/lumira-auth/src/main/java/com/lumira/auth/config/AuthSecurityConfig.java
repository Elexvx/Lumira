...
public class AuthSecurityConfig {
    ...
    private final AuthJwtAuthFilter authJwtAuthFilter;
    private final ObjectMapper objectMapper;

    public AuthSecurityConfig(
            TraceIdFilter traceIdFilter,
            InternalServiceTokenAuthFilter internalServiceTokenAuthFilter,
            AuthJwtAuthFilter authJwtAuthFilter,
            ObjectMapper objectMapper
    ) {
        this.traceIdFilter = traceIdFilter;
        this.internalServiceTokenAuthFilter = internalServiceTokenAuthFilter;
        this.authJwtAuthFilter = authJwtAuthFilter;
        this.objectMapper = objectMapper;
    }

    @Bean
    public SecurityFilterChain authSecurityFilterChain(HttpSecurity http, AuthSecurityProperties securityProperties) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .addFilterAfter(authJwtAuthFilter, InternalServiceTokenAuthFilter.class);
        return http.build();
    }
