...
public class MessageSecurityConfig {
    ...
    @Bean
    public SecurityFilterChain messageSecurityFilterChain(HttpSecurity http, SecurityProperties securityProperties) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .addFilterAfter(messageJwtAuthFilter, InternalServiceTokenAuthFilter.class);
        return http.build();
    }
