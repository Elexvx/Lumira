...
public class MessageReadinessV2Controller {
    ...
    private List<OwnerObservabilityDTO.MetricDTO> messageMetrics() {
        ...
        return List.of(
                metric("message.list.p95", "timer", "milliseconds", "Message list p95 latency; computed by the metrics lumira-backend from the v2 list endpoint.", snapshot.listMessagesP95Millis()),
