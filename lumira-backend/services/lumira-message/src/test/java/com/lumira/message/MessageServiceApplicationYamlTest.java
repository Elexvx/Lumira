...
class MessageServiceApplicationYamlTest {

    @Test
    void standaloneMessageServiceBridgesSharedDeploymentEnvNames() {
        Properties properties = loadApplicationProperties();

        assertThat(properties.getProperty("spring.application.name")).isEqualTo("message-service");
        ...
        assertThat(properties.getProperty("saas.security.permit-paths[0]")).isEqualTo("/ws/message");
        assertThat(properties.getProperty("saas.security.permit-paths[7]")).isEqualTo("/api/v2/message/readiness");
        assertThat(properties.getProperty("saas.security.permit-paths[8]")).isEqualTo("/api/v2/message/health");
        assertThat(properties.getProperty("saas.security.permit-paths[9]")).isEqualTo("/api/v2/message/metrics");
