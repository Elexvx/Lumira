...
class PaymentJwtAuthFilterTest {

    private final JwtTokenService jwtTokenService = mock(JwtTokenService.class);
    private final AuthInternalApi authInternalApi = mock(AuthInternalApi.class);
    private final PaymentJwtAuthFilter filter = new PaymentJwtAuthFilter(jwtTokenService, authInternalApi);
    ...
    void rejectsOversizedBearerBeforeParsing() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/api/v1/payment/orders");
