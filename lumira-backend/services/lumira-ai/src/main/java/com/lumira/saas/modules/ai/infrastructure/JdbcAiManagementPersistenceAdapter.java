...
import com.lumira.saas.modules.ai.app.AiChatModelFactory;
import com.lumira.saas.modules.ai.app.AiEmployeeRuntimeService;
...
/**
 * Compatibility persistence adapter for AI management operations.  It keeps
 * legacy transactional SQL behind the application facade while the physical
 * AI owner is being extracted from the modular monolith.
 */
@Repository
public class JdbcAiManagementPersistenceAdapter implements AiManagementPersistencePort {
    ...
    @Autowired
    public JdbcAiManagementPersistenceAdapter(
    ...
    private JdbcAiManagementPersistenceAdapter(
            MyBatisQueryOperations jdbcTemplate,
            AiOperationAuditLogger operationAuditService,
            AiSecretCryptoService aiSecretCryptoService,
            AiEmployeeRuntimeService aiEmployeeRuntimeService,
        ...
        this.assistantEmployeeRepository = new JdbcAiAssistantEmployeeRepository(jdbcTemplate);
    ...
    public AiVO.EmployeeVO getAssistantEmployee(CurrentUser currentUser) {
        ...
        return assistantEmployeeRepository.findEnabled("ai-assistant")
                .filter(employee -> employee.getId() != null)
                .orElseThrow(() -> new BizException(ErrorCode.NOT_FOUND, "AI assistant employee is unavailable"));
    }
