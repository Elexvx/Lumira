...
class DefaultAiEmployeeRuntimeService implements AiEmployeeRuntimeService {
    ...
    private final AiEmployeeRuntimeRepository employeeRuntimeRepository;
    ...
    DefaultAiEmployeeRuntimeService(
            AiEmployeeRuntimeRepository employeeRuntimeRepository,
    ...
    private DefaultAiEmployeeRuntimeService(
        ...
        this.employeeRuntimeRepository = employeeRuntimeRepository;
    ...
    private void insertToolAuditLog(
        ...
        int inserted = employeeRuntimeRepository.appendChatAudit(new AiEmployeeRuntimeRepository.ChatAuditLog(
                conversationId,
                employeeId,
                ownerUserId,
                ownerUserUuid,
    ...
    private AiVO.EmployeeDetailVO queryEmployeeDetail(Long employeeId) {
        AiVO.EmployeeDetailVO employee = employeeRuntimeRepository.findEmployeeDetail(employeeId).orElse(null);
        if (employee == null) {
    ...
    private String queryConversationCode(Long conversationId) {
        return employeeRuntimeRepository.findConversationCode(conversationId).orElse(null);
    }
