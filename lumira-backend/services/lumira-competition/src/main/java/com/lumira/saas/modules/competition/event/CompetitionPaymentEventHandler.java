...
@Service
public class CompetitionPaymentEventHandler implements com.lumira.api.competition.CompetitionPaymentEventHandler {
    static final String CONSUMER_NAME = "competition-payment-order-paid-v1";

    private final JdbcTemplate jdbcTemplate;
    private final EventConsumptionPort consumptionGuard;

    public CompetitionPaymentEventHandler(JdbcTemplate jdbcTemplate, EventConsumptionPort consumptionGuard) {
