...
public class OnlineSessionController {
    ...
    public OnlineSessionController(
        ...
        this(onlineSessionManagementAppService, securityContextFacade, permissionGuard, null, null, null, false);
    }
    ...
    public OnlineSessionController(
        ...
        this(onlineSessionManagementAppService, securityContextFacade, permissionGuard, permissionSnapshotService, null, null, false);
    }
    ...
    public OnlineSessionController(
        ...
        this(onlineSessionManagementAppService, securityContextFacade, permissionGuard, permissionSnapshotService, null, sessionAuthenticationService, false);
    }
    ...
    public OnlineSessionController(
        ...
        this(onlineSessionManagementAppService, securityContextFacade, permissionGuard, permissionSnapshotService, systemInternalApi, sessionAuthenticationService, true);
    }

    private OnlineSessionController(
            OnlineSessionManagementAppService onlineSessionManagementAppService,
            SecurityContextFacade securityContextFacade,
            PermissionGuard permissionGuard,
            PermissionSnapshotService permissionSnapshotService,
