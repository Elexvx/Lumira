...
public class SystemDepartmentController {
    ...
    public SystemDepartmentController(
        ...
        this(departmentAppService, securityContextFacade, permissionGuard, null, null, null, false);
    }
    ...
    public SystemDepartmentController(
        ...
        this(departmentAppService, securityContextFacade, permissionGuard, permissionSnapshotService, null, null, false);
    }
    ...
    public SystemDepartmentController(
        ...
        this(departmentAppService, securityContextFacade, permissionGuard, permissionSnapshotService, null, sessionAuthenticationService, false);
    }
    ...
    public SystemDepartmentController(
        ...
        this(departmentAppService, securityContextFacade, permissionGuard, permissionSnapshotService, systemInternalApi, sessionAuthenticationService, true);
    }

    private SystemDepartmentController(
            SystemDepartmentAppService departmentAppService,
            SecurityContextFacade securityContextFacade,
            PermissionGuard permissionGuard,
            PermissionSnapshotService permissionSnapshotService,
