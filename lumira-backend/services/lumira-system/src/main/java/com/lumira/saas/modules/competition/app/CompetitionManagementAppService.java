...
public class CompetitionManagementAppService {
    ...
    public CompetitionManagementAppService(
        ...
        this(jdbcTemplate, dictRuntimeService, permissionSnapshotService, null, sessionAuthenticationService);
    }
