...
/** Workflow-local bean mapper which preserves the prior lenient row mapping. */
public class WorkflowBeanPropertyRowMapper<T> implements WorkflowRowMapper<T> {
    private final Class<T> mappedClass;

    public WorkflowBeanPropertyRowMapper(Class<T> mappedClass) {
        this.mappedClass = mappedClass;
    }

    @Override
    public T mapRow(WorkflowSqlRow row, int rowNum) {
    ...
    private void setField(T instance, String propertyName, Object value) {
        ...
        try {
            ...
            // Keep mapping lenient for non-writable projection fields.
        }
    }
