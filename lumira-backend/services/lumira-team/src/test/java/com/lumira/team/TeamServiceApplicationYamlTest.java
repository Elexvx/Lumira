...
class TeamServiceApplicationYamlTest {

    @Test
    void standaloneTeamServiceBridgesSharedDeploymentEnvNames() {
        Properties properties = loadApplicationProperties();

        assertThat(properties.getProperty("spring.application.name")).isEqualTo("team-service");
