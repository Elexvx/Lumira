...
import com.lumira.team.security.SecurityProperties;
import com.lumira.team.security.TeamJwtAuthFilter;
...
public class TeamSecurityConfig {
    ...
    private final TeamJwtAuthFilter teamJwtAuthFilter;
    private final ObjectMapper objectMapper;

    public TeamSecurityConfig(
            TraceIdFilter traceIdFilter,
            InternalServiceTokenAuthFilter internalServiceTokenAuthFilter,
            TeamJwtAuthFilter teamJwtAuthFilter,
            ObjectMapper objectMapper
    ) {
        this.traceIdFilter = traceIdFilter;
        this.internalServiceTokenAuthFilter = internalServiceTokenAuthFilter;
        this.teamJwtAuthFilter = teamJwtAuthFilter;
        this.objectMapper = objectMapper;
    }

    @Bean
    public SecurityFilterChain teamSecurityFilterChain(HttpSecurity http, SecurityProperties securityProperties) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .addFilterAfter(teamJwtAuthFilter, InternalServiceTokenAuthFilter.class);
        return http.build();
    }
