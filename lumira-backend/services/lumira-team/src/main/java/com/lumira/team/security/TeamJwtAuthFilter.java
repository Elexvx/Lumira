...
public class TeamJwtAuthFilter extends OncePerRequestFilter {
    ...
    public TeamJwtAuthFilter(JwtTokenService jwtTokenService, AuthInternalApi authInternalApi) {
