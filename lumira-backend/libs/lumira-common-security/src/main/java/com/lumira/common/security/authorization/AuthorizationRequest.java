...
public record AuthorizationRequest(
    ...
    public static AuthorizationRequest permission(CurrentUser currentUser, String permissionKey) {
        Long userId = trustedUserIdOrNull(currentUser);
        String userUuid = trustedUserUuidOrNull(currentUser);
    ...
    public static AuthorizationRequest aiTool(CurrentUser currentUser, Long employeeId, String toolCode,
        ...
        return aiToolAction(currentUser, employeeId, toolCode, permissionKey, riskLevel, "execute",
                confirmed, approvalGranted, arguments);
    }

    public static AuthorizationRequest aiToolAction(CurrentUser currentUser, Long employeeId, String toolCode,
                                                    String permissionKey, String riskLevel, String actionCode,
                                                    boolean confirmed, boolean approvalGranted,
                                                    Map<String, Object> arguments) {
        Long userId = trustedUserIdOrNull(currentUser);
        String userUuid = trustedUserUuidOrNull(currentUser);
        return new AuthorizationRequest(SubjectRef.humanUser(userId),
                SubjectRef.digitalEmployee(employeeId), userId, userUuid, employeeId, "ai_tool", actionCode,
    ...
    public static AuthorizationRequest aiToolAccess(CurrentUser currentUser, Long employeeId, String toolCode,
                                                    String permissionKey, String riskLevel, String actionCode,
                                                    Map<String, Object> arguments) {
        return aiToolAction(currentUser, employeeId, toolCode, permissionKey, riskLevel, actionCode,
    ...
    public static AuthorizationRequest plugin(CurrentUser currentUser, String permissionKey, String pluginCode) {
        Long userId = trustedUserIdOrNull(currentUser);
        String userUuid = trustedUserUuidOrNull(currentUser);
        return new AuthorizationRequest(SubjectRef.humanUser(userId), null, userId, userUuid, null,
    ...
    public static AuthorizationRequest systemJob(String resourceCode, String actionCode, String requestId) {
        return new AuthorizationRequest(null, null, null, null, null, resourceCode, actionCode,
                null, null, "LOW", null, Map.of("systemPrincipal", Boolean.TRUE), false, true,
                "SYSTEM_JOB", requestId, null, null);
    }

    private static Long trustedUserIdOrNull(CurrentUser currentUser) {
    ...
    private static String trustedUserUuidOrNull(CurrentUser currentUser) {
        if (!isTrustedCurrentUser(currentUser)) {
            return null;
        }
