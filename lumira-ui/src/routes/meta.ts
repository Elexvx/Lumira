...
export const systemRouteMeta: BackendRouteMeta[] = [
  ...
  { path: '/settings/alerting', name: 'nav.plugins.alerting', icon: 'AlertOutlined', access: 'canVisitAlertingPlugin' },
...
export const systemRoutes: BackendRouteRecord[] = [
  ...
  { path: '/system/monitoring/audit', redirect: '/settings/audit' },
  {
    ...
    routes: [
      ...
      { path: '/settings/alerting', component: '@/pages/plugins/AlertingPage', name: 'nav.plugins.alerting', icon: 'AlertOutlined', access: 'canVisitAlertingPlugin' },
