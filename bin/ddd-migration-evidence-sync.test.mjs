...
for (const ownerModule of expectedOwnerModules) {
  assert.match(
    ...
    `${ownerModule} must be represented in doc/27-ddd-owner-table-manifest.csv`,
  );
}
...
const explainMigrationLocations = new Map([
  ["platform-runtime-appearance.json", ["services/lumira-system/src/main/resources/db/migration"]],
  ["plugin-bootstrap.json", [
    "services/lumira-system/src/main/resources/db/migration",
    "services/lumira-plugin/src/main/resources/db/migration/plugin",
  ]],
  ["message-visible-list.json", [
    "services/lumira-system/src/main/resources/db/migration",
    "services/lumira-message/src/main/resources/db/migration/message",
  ]],
  ...
  ["ai-knowledge-index-retry.json", [
    "services/lumira-system/src/main/resources/db/migration",
    "services/lumira-ai/src/main/resources/db/migration/ai",
  ]],
  ...
  ["platform-outbox-owner-relay-file.json", [
    "services/lumira-system/src/main/resources/db/migration",
    "services/lumira-file/src/main/resources/db/migration/file",
  ]],
]);
...
const messageMigrationSql = migrationSqlByLocation.get("services/lumira-message/src/main/resources/db/migration/message") || "";
const systemMigrationSql = migrationSqlByLocation.get("services/lumira-system/src/main/resources/db/migration") || "";
...
for (const [location, sql] of [
  ["services/lumira-system/src/main/resources/db/migration", systemMigrationSql],
  ["services/lumira-message/src/main/resources/db/migration/message", messageMigrationSql],
]) {
  assert.match(
    sql,
...
const aiMigrationSql = migrationSqlByLocation.get("services/lumira-ai/src/main/resources/db/migration/ai") || "";
for (const token of [
  "index_retry_count",
  "index_next_retry_at",
  "index_last_error",
