...
`);
  writeFileSync(envFile, [
    ...
    'DB_MIGRATION_PASSWORD=e2e-migrator-password',
    'MYSQL_BACKUP_USERNAME=lumira_backup',
    'MYSQL_BACKUP_PASSWORD=e2e-backup-password',
    'MYSQL_RESTORE_USERNAME=lumira_restore',
    'MYSQL_RESTORE_PASSWORD=e2e-restore-password',
    'XXL_JOB_DB_USERNAME=xxl_job',
    'XXL_JOB_DB_PASSWORD=e2e-xxl-password',
    'XXL_JOB_DB_URL=jdbc:mysql://mysql:3306/xxl_job',
    'MYSQLD_EXPORTER_USERNAME=lumira_exporter',
    'MYSQLD_EXPORTER_PASSWORD=e2e-exporter-password',
    'REDIS_CACHE_HOST=redis-cache',
    'REDIS_CACHE_PORT=6379',
    'REDIS_CACHE_PASSWORD=e2e-cache-password',
    'REDIS_RUNTIME_HOST=redis-runtime',
    'REDIS_RUNTIME_PORT=6379',
    'REDIS_RUNTIME_PASSWORD=e2e-runtime-password',
