...
for (const [key, value] of Object.entries({
  ...
  LUMIRA_SERVER_BLUE_FRONTEND_VERSION: env.LUMIRA_SERVER_BLUE_FRONTEND_VERSION || env.FRONTEND_VERSION,
  LUMIRA_SERVER_GREEN_FRONTEND_VERSION: env.LUMIRA_SERVER_GREEN_FRONTEND_VERSION || env.FRONTEND_VERSION,
  LUMIRA_SERVER_BLUE_BACKEND_VERSION: env.LUMIRA_SERVER_BLUE_BACKEND_VERSION || env.BACKEND_VERSION,
  LUMIRA_SERVER_GREEN_BACKEND_VERSION: env.LUMIRA_SERVER_GREEN_BACKEND_VERSION || env.BACKEND_VERSION,
  ...
  LUMIRA_SERVER_BLUE_GIT_BRANCH: env.LUMIRA_SERVER_BLUE_GIT_BRANCH || env.GIT_BRANCH,
  LUMIRA_SERVER_GREEN_GIT_BRANCH: env.LUMIRA_SERVER_GREEN_GIT_BRANCH || env.GIT_BRANCH,
