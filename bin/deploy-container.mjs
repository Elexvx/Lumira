...
function printHelp() {
  console.log(`Usage: node bin\/deploy-container.mjs [options]
...
async function confirmReset() {
  ...
  const frontendOrigin = env.FRONTEND_ORIGIN || process.env.FRONTEND_ORIGIN || 'unknown-lumira-ui-origin';
  ...
  console.error(`Target lumira-ui origin: ${frontendOrigin}`);
