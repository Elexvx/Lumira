...

{
  ...
  assert(issues.includes("no migration files in services/lumira-system/src/main/resources/db/migration"));
  assert(issues.includes("migration count mismatch in services/lumira-system/src/main/resources/db/migration: declared=0, actual=1"));
}
