...
export const requiredPhysicalSplitContexts = Object.freeze([
  { name: "IAM", module: "services/lumira-system", route: "/api/v2/iam", ownerContext: "IAM", physicalServiceTarget: false },
  { name: "Auth", module: "services/lumira-auth", route: "/api/v2/auth", ownerContext: "AUTH", physicalServiceTarget: true },
  { name: "Platform", module: "services/lumira-system", route: "/api/v2/platform", ownerContext: "PLATFORM", physicalServiceTarget: false },
  { name: "Message", module: "services/lumira-message", route: "/api/v2/message", ownerContext: "MESSAGE", physicalServiceTarget: true },
  { name: "File", module: "services/lumira-file", route: "/api/v2/files", ownerContext: "FILE", physicalServiceTarget: true },
  { name: "Plugin", module: "services/lumira-plugin", route: "/api/v2/plugins", ownerContext: "PLUGIN", physicalServiceTarget: true },
  { name: "Localization", module: "services/lumira-localization", route: "/api/v2/localization", ownerContext: "LOCALIZATION", physicalServiceTarget: true },
  { name: "Payment", module: "services/lumira-payment", route: "/api/v2/payment", ownerContext: "PAYMENT", physicalServiceTarget: true },
  { name: "AI", module: "services/lumira-ai", route: "/api/v2/ai", ownerContext: "AI", physicalServiceTarget: true },
  { name: "Job", module: "services/lumira-quartz", route: "/api/v2/job", ownerContext: "JOB", physicalServiceTarget: false },
]);
