...
Environment:
  ...
  DDD_FRONTEND_EXPECT_DEPLOYED          Set true before lumira-ui staging smoke evidence.
...
const frontendProductionEquivalence = buildProductionEquivalenceEvidence({
  ...
  evidenceName: "lumira-ui runtime staging check",
});
...
const result = {
  ...
  productionEquivalence: {
    ...
    "lumira-ui": frontendProductionEquivalence,
  },
  urlChecks,
  evidenceChecks,
  expectationChecks,
