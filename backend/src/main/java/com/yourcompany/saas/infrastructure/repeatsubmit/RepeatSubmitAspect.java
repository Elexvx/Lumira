package com.yourcompany.saas.infrastructure.repeatsubmit;

import com.yourcompany.saas.common.annotation.RepeatSubmit;
...
import com.yourcompany.saas.common.util.RequestContextUtils;
...
public class RepeatSubmitAspect {
    ...
    @Around("@annotation(com.yourcompany.saas.common.annotation.RepeatSubmit)")
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        boolean acquired = cacheTemplate.putIfAbsent(key, "1", ttl);
        if (!acquired) {
    ...
    private String resolveScope(HttpServletRequest request) {
        ...
        String tenantId = request.getHeader(com.yourcompany.saas.common.constant.HeaderConstants.TENANT_ID);
    ...
    private Object sanitizeArgument(Object argument) {
        ...
        if (argument instanceof MultipartFile[] multipartFiles) {
            return Arrays.stream(multipartFiles)
                    .map(this::multipartFileDescriptor)
                    .toList();
        }
