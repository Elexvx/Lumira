...
public class OpenApiSignatureFilter extends OncePerRequestFilter {
    ...
    private void writeFailure(HttpServletRequest request, HttpServletResponse response, RuntimeException exception) throws IOException {
        ErrorCode errorCode = exception instanceof com.yourcompany.saas.common.exception.BizException bizException
                ? bizException.getErrorCode()
                : ErrorCode.UNAUTHORIZED;
        ApiResponse<Void> body = exception instanceof com.yourcompany.saas.common.exception.BizException bizException
                ? ApiResponse.fail(
                        bizException.getErrorCode(),
