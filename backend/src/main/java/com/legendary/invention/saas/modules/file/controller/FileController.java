...
public class FileController {
    ...
    @GetMapping
    public ApiResponse<PageResponse<FileVO.FileObjectVO>> list(
    ...
    @GetMapping("/{id}")
    public ApiResponse<FileVO.FileObjectVO> detail(
    ...
    public ResponseEntity<Resource> download(
        ...
        boolean tenantScope = FileManagementAppService.SCOPE_TENANT.equalsIgnoreCase(scope);
        require(tenantScope ? "system:file:manage" : "system:file:view");
        FileVO.FileObjectVO file = fileManagementAppService.getFile(securityContextFacade.getCurrentUser(), id, tenantScope);
