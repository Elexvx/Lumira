...
VALUES
  ...
  (3030, 1001, 3028, 'files.all', '全站文件管理', 'MENU', '/settings/files/all', '@/pages/settings/files/Center', 0, NOW(), 0, NOW(), 0, 'FolderOpenOutlined', 2, 'system:file:manage', 'ENABLED'),
  ...
  (4030, 1002, 4028, 'files.all', '全站文件管理', 'MENU', '/settings/files/all', '@/pages/settings/files/Center', 0, NOW(), 0, NOW(), 0, 'FolderOpenOutlined', 2, 'system:file:manage', 'ENABLED');
