...
INSERT INTO tenant_info (id, tenant_code, tenant_name, tenant_short_name, status, created_by, updated_by, deleted)
...
INSERT INTO sys_user (
    id, username, nickname, real_name, password_hash, mobile, email, status, created_by, updated_by, deleted
)
SELECT
...
WHERE NOT EXISTS (SELECT 1 FROM sys_user_role WHERE tenant_id = 1001 AND user_id = 1001 AND role_id = 2001);

INSERT INTO sys_user_role (tenant_id, user_id, role_id, created_by, updated_by, deleted)
SELECT 1002, 1001, 2002, 0, 0, 0
WHERE NOT EXISTS (SELECT 1 FROM sys_user_role WHERE tenant_id = 1002 AND user_id = 1001 AND role_id = 2002);
...
INSERT INTO sys_menu (
    id, tenant_id, parent_id, menu_code, menu_name, menu_type, path, component, icon, sort_no, permission_key, created_by, updated_by, deleted
)
