package com.legendary.invention.file.infrastructure.security;
...
public class SecurityConfig {
    ...
    public SecurityConfig(TraceIdFilter traceIdFilter, FileJwtAuthFilter fileJwtAuthFilter, ObjectMapper objectMapper) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, SecurityProperties securityProperties) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .addFilterAfter(fileJwtAuthFilter, TraceIdFilter.class);
        return http.build();
    }
    ...
    private BizException resolveAuthBizException(HttpServletRequest request) {
        Object attribute = request.getAttribute("fileAuthBizException");
