...
| IAM | `lumira-system` | `iam_user*`, `iam_subject*`, `iam_permission`, `iam_delegation_grant`, `sys_user`, `sys_role`, `sys_role_permission`, `sys_menu`, `sys_permission`, `sys_user_role`, `sys_user_tenant*`, `sys_department`, `sys_department_closure`, `sys_user_department`, `sys_role_data_scope`, `sys_tenant` | - | Identity and permission master data. |
