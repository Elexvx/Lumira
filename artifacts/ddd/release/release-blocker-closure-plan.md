...
RUN_NOW_LOCAL: 3
RUN_NOW_WITH_REAL_ENV: 15
WAIT_FOR_DEPENDENCIES: 29
Runnable waves: 4
...
- Item orders: 10, 11, 12, 13, 14, 15, 16, 17, 18
...
## 9. release-owner / manifest-missing-no-explain-json-files-in-tmp-ddd-explain
...
## 10. release-performance / performance-actual-shape-1
...
## 11. release-performance / performance-actual-shape-2
...
## 12. release-performance / performance-actual-shape-3
...
## 13. release-performance / performance-actual-shape-4
...
## 14. release-performance / performance-baseline-metadata-5
...
## 15. release-performance / performance-baseline-metadata-6
...
## 16. release-performance / performance-baseline-metadata-7
...
## 17. release-performance / performance-baseline-metadata-8
...
## 18. release-performance / performance-baseline-metadata-9
...
## 19. ai / ai-owner-gateway

- Closure kind: WAIT_FOR_DEPENDENCIES
- Priority: P1
- Source: ai-runtime
- Batch: p1-ai-runtime-ai (blocked)
- Dependencies: p0-docker-release-infra, p0-runtime-readiness-release-infra, p0-manifest-release-owner, p0-authenticated-performance-release-performance
...
## 22. frontend / frontend-deployed-expectation
...
## 23. file-owner / file-processing-production-equivalence
...
## 24. job-owner / job-e2e-production-equivalence
...
## 25. payment-owner / payment-webhook-production-equivalence
...
## 31. localization-owner / Localization
...
## 39. database / message-visible-list.json
...
## 40. database / platform-outbox-owner-relay-file.json
...
## 41. database / platform-outbox-owner-relay-message.json
...
## 42. database / platform-runtime-appearance.json
...
## 43. database / plugin-bootstrap.json
...
## 44. database / orchestrator-preflight-migration-runtime-evidence
...
## 45. frontend / orchestrator-preflight-frontend-runtime-base-url
...
## 46. release-infra / orchestrator-preflight-backend-runtime-base-url
...
## 47. release-owner / orchestrator-run-mode
