...
- Keys: LUMIRA_BASE_URL, CORS_ALLOWED_ORIGIN_PATTERNS, DB_PASSWORD, DB_URL, DB_USERNAME, FIELD_SECRET, JWT_SECRET, PLAYWRIGHT_BASE_URL, REDIS_HOST, REDIS_PASSWORD, REDIS_PORT, TRUST_FORWARDED_HEADERS
