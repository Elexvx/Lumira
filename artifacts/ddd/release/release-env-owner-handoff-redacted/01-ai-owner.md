...
- `LUMIRA_AI_OWNER_INTEGRATIONS_FILE_BASE_URL`: status=FILLED_REDACTED; class=url; secret=false; required=true; blocker=false; safeDefaultAvailable=false; requiresOwnerInput=false; reason=not-blocking; https=true; nonLocal=true; minLength=none; expectedValues=none
...
- `LUMIRA_AI_OWNER_INTEGRATIONS_IAM_ENABLED`: status=FILLED_REDACTED; class=toggle; secret=false; required=true; blocker=false; safeDefaultAvailable=false; requiresOwnerInput=false; reason=not-blocking; https=false; nonLocal=false; minLength=none; expectedValues=true
  guidance: Use one of: true.
- `LUMIRA_AI_OWNER_INTEGRATIONS_IAM_BASE_URL`: status=FILLED_REDACTED; class=url; secret=false; required=true; blocker=false; safeDefaultAvailable=false; requiresOwnerInput=false; reason=not-blocking; https=true; nonLocal=true; minLength=none; expectedValues=none
  guidance: Use the production-equivalent HTTPS endpoint; localhost, example, and test domains are rejected.
- `LUMIRA_AI_OWNER_INTEGRATIONS_INTERNAL_TOKEN`: status=FILLED_REDACTED; class=secret; secret=true; required=true; blocker=false; safeDefaultAvailable=false; requiresOwnerInput=false; reason=not-blocking; https=false; nonLocal=false; minLength=32; expectedValues=none
...
- `LUMIRA_AI_OWNER_INTEGRATIONS_PLATFORM_ENABLED`: status=FILLED_REDACTED; class=toggle; secret=false; required=true; blocker=false; safeDefaultAvailable=false; requiresOwnerInput=false; reason=not-blocking; https=false; nonLocal=false; minLength=none; expectedValues=true
  guidance: Use one of: true.
- `LUMIRA_AI_OWNER_INTEGRATIONS_PLATFORM_BASE_URL`: status=FILLED_REDACTED; class=url; secret=false; required=true; blocker=false; safeDefaultAvailable=false; requiresOwnerInput=false; reason=not-blocking; https=true; nonLocal=true; minLength=none; expectedValues=none
  guidance: Use the production-equivalent HTTPS endpoint; localhost, example, and test domains are rejected.
- `LUMIRA_AI_PROVIDER_OPENAI_COMPATIBLE_API_KEY`: status=FILLED_REDACTED; class=secret; secret=true; required=true; blocker=false; safeDefaultAvailable=false; requiresOwnerInput=false; reason=not-blocking; https=false; nonLocal=false; minLength=32; expectedValues=none
  guidance: Provide via approved secret manager or secure release channel; never commit.
- `LUMIRA_AI_PROVIDER_OPENAI_COMPATIBLE_BASE_URL`: status=FILLED_REDACTED; class=url; secret=false; required=true; blocker=false; safeDefaultAvailable=false; requiresOwnerInput=false; reason=not-blocking; https=true; nonLocal=true; minLength=none; expectedValues=none
  guidance: Use the production-equivalent HTTPS endpoint; localhost, example, and test domains are rejected.
