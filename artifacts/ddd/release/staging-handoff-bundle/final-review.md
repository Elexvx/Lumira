...
| All staging evidence gates accepted | no | `node scripts/ddd-staging-execution-checklist.mjs --evidence-acceptance` | accepted=1/6 |
| Final rollup allows cutover | no | `node scripts/ddd-staging-execution-checklist.mjs --rollup-enforce` | NO_GO_STRICT; blocked=5/6 |
...
| release-infra | `owner-packets/release-infra.blocking-inputs.template.env` | 4 | 10 | 3 | 0 |
