...
| Every staging evidence gate is accepted | BLOCKED | `artifacts/ddd/release/staging-handoff-bundle/evidence-acceptance.json` | `node scripts/ddd-staging-execution-checklist.mjs --evidence-acceptance` | accepted=1/6 |
| Critical path phases are all clear | BLOCKED | `artifacts/ddd/release/staging-handoff-bundle/operator-progress.json` | `node scripts/ddd-staging-execution-checklist.mjs --operator-progress-markdown` | blocked=5/6 |
...
- staging-evidence-accepted: accepted=1/6; command=`node scripts/ddd-staging-execution-checklist.mjs --evidence-acceptance`
- critical-path-clear: blocked=5/6; command=`node scripts/ddd-staging-execution-checklist.mjs --operator-progress-markdown`
