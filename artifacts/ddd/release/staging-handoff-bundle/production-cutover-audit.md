...
| Every staging evidence gate is accepted | BLOCKED | `artifacts/ddd/release/staging-handoff-bundle/evidence-acceptance.json` | `node scripts/ddd-staging-execution-checklist.mjs --evidence-acceptance` | accepted=0/6 |
| Critical path phases are all clear | BLOCKED | `artifacts/ddd/release/staging-handoff-bundle/operator-progress.json` | `node scripts/ddd-staging-execution-checklist.mjs --operator-progress-markdown` | blocked=6/6 |
...
- staging-evidence-accepted: accepted=0/6; command=`node scripts/ddd-staging-execution-checklist.mjs --evidence-acceptance`
- critical-path-clear: blocked=6/6; command=`node scripts/ddd-staging-execution-checklist.mjs --operator-progress-markdown`
