...
| 2 | `p0-docker-images` | release-infra | release-infra | none | none | BLOCKED | Produce Docker build or existing-image inspect evidence | `node scripts/ddd-staging-execution-checklist.mjs --docker-image-submission-plan-markdown` | `docker-image-submission-plan.json` |
