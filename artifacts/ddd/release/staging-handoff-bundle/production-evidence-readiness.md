...
- owner-evidence: missingArtifacts=2; blockingInputs=54; command=`node scripts/ddd-staging-execution-checklist.mjs --data-safety-submission-plan-markdown`; verify=`node scripts/ddd-staging-execution-checklist.mjs --owner-evidence-intake-markdown`
