...
| Release-owner final review and strict gate | BLOCKED | release-owner | p1-runtime-business, p1-rollback, p2-migration, p2-explain | `node scripts/ddd-staging-execution-checklist.mjs --evidence-acceptance` | accepted=1/6 |
