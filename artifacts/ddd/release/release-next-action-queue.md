...
- Reason: strictGate=physical-split-readiness IAM module must be services/lumira-system, got services/system-service
- Executable commands:
  - `node bin/ddd-release-evidence-orchestrator.mjs`
...
- Reason: strictGate=migration-evidence-freshness generatedAt is 69.4h old; limit=24h
- Executable commands:
...
- Executable commands:
  - `DDD_AI_EXPECT_PROVIDER_REMOTE=true DDD_AI_EXPECT_OWNER_GATEWAY_REMOTE=true node bin/ddd-ai-runtime-drill.mjs`
...
- Reason: strictGate=file-processing-freshness finishedAt is 143.5h old; limit=24h
- Executable commands:
...
- Reason: strictGate=job-e2e-freshness checkedAt is 143.1h old; limit=24h
- Executable commands:
...
- Reason: strictGate=payment-webhook-freshness finishedAt is 143.3h old; limit=24h
- Executable commands:
