# Rollback Deferral Handoff: auth-owner
...
|---|---|---|---|
| Auth | Exercise auth adapter rollback with session TTL compatibility, login smoke, and forced logout/keepalive evidence. | CHANGE-12345 | replace-with-future-iso-timestamp |
