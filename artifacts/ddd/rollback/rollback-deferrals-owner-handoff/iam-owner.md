# Rollback Deferral Handoff: iam-owner
...
|---|---|---|---|
| IAM | Exercise permission snapshot rollback, cache invalidation, and IAM v2-to-v1 adapter fallback; attach readiness, audit, and cache evidence. | CHANGE-12345 | replace-with-future-iso-timestamp |
