# Rollback Deferral Handoff: localization-owner
...
|---|---|---|---|
| Localization | Exercise localization release rollback and runtime bundle cache clear; attach release id, bundle metrics, and audit evidence. | CHANGE-12345 | replace-with-future-iso-timestamp |
