# Rollback Deferral Handoff: platform-owner
...
|---|---|---|---|
| Platform | Exercise platform config/runtime appearance rollback and cache clear; attach bootstrap/config version and audit evidence. | CHANGE-12345 | replace-with-future-iso-timestamp |
