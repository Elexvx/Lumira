# Rollback Deferral Handoff: ai-owner
...
|---|---|---|---|
| AI | Exercise AI provider disablement, knowledge index job pause, and document index rebuild/degraded chat transcript evidence. | CHANGE-12345 | replace-with-future-iso-timestamp |
