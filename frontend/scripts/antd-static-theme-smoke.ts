...
const run = () => {
  ...
  assert.deepEqual(darkTheme?.cssVar, { key: 'legendary-dark' }, 'dark theme should use an explicit antd css var scope');
  ...
  assert.deepEqual(lightTheme?.cssVar, { key: 'legendary-light' }, 'light theme should use an explicit antd css var scope');
  ...
  assert.deepEqual(compactTheme?.cssVar, { key: 'legendary-compact' }, 'compact theme should use an explicit antd css var scope');
