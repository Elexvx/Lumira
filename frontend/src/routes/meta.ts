...
export const backendRouteMeta: BackendRouteMeta[] = [
  ...
  { path: '/iam/overview', name: '权限管理', icon: 'SafetyCertificateOutlined', access: 'canVisitIam', hideInMenu: true },
  ...
  { path: '/user-center/permissions', name: '权限管理', icon: 'SafetyCertificateOutlined', access: 'canVisitIam' },
...
export const backendRoutes = [
  ...
  { path: '/iam/overview', redirect: '/user-center/permissions' },
  ...
  { path: '/profile/center', redirect: '/user-center/profile' },
  {
    ...
    routes: [
      ...
      { path: '/user-center/permissions', component: '@/pages/iam/Overview', name: '权限管理', icon: 'SafetyCertificateOutlined', access: 'canVisitIam' },
