...
export const backendRouteMeta: BackendRouteMeta[] = [
  ...
  { path: '/settings/monitoring/api-docs', name: 'nav.system.monitoring.apiDocs', icon: 'FileTextOutlined', access: 'canVisitSystemMonitoringDocs' },
  { path: '/settings/monitoring/audit', name: 'nav.system.monitoring.audit', icon: 'AuditOutlined', access: 'canVisitAudit' },
  ...
  { path: '/localization', name: 'nav.localization.root', icon: 'TranslationOutlined', access: 'canVisitLocalization' },
...
export const backendRoutes: BackendRouteRecord[] = [
  ...
  { path: '/audit/overview', redirect: '/settings/monitoring/audit' },
  ...
  { path: '/system/monitoring/api-docs', redirect: '/settings/monitoring/api-docs' },
  { path: '/system/monitoring/audit', redirect: '/settings/monitoring/audit' },
  {
    path: '/user-center',
    ...
    routes: [
      ...
      { path: '/settings/files/all', component: '@/pages/files/Center', name: 'nav.files.all', icon: 'FolderOpenOutlined', access: 'canVisitSystemAllFiles' },
      {
        ...
        routes: [
          ...
          { path: '/settings/monitoring/api-docs', component: '@/pages/settings/monitoring/ApiDocs', name: 'nav.system.monitoring.apiDocs', icon: 'FileTextOutlined', access: 'canVisitSystemMonitoringDocs' },
          { path: '/settings/monitoring/audit', component: '@/pages/settings/monitoring/Audit', name: 'nav.system.monitoring.audit', icon: 'AuditOutlined', access: 'canVisitAudit' },
        ],
      },
    ],
  },
  {
    path: '/localization',
    component: '@/pages/localization/Overview',
