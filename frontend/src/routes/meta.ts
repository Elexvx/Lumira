...
export const backendRouteMeta: BackendRouteMeta[] = [
  ...
  { path: '/system/notifications', name: '消息中心', icon: 'NotificationOutlined', access: 'canVisitSystemNotifications' },
...
export const backendRoutes: BackendRouteRecord[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      { path: '/system/notifications', component: '@/pages/system/notifications/index', name: '消息中心', icon: 'NotificationOutlined', access: 'canVisitSystemNotifications' },
  ...
  { path: '/plugins/announcement', redirect: '/system/notifications' },
