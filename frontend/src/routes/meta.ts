...
export const backendRouteMeta: BackendRouteMeta[] = [
  ...
  { path: '/system/online-users', name: '在线用户', icon: 'UserSwitchOutlined', access: 'canVisitSystemOnlineUsers' },
...
export const backendRoutes = [
  ...
  { path: '/profile/center', component: '@/pages/profile/Center', name: '个人中心', icon: 'UserOutlined', access: 'canVisitProfile' },
  {
    ...
    routes: [
      ...
      { path: '/system/online-users', component: '@/pages/system/online-users', name: '在线用户', icon: 'UserSwitchOutlined', access: 'canVisitSystemOnlineUsers' },
