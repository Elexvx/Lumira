...
export const backendRouteMeta: BackendRouteMeta[] = [
  ...
  { path: '/site', name: 'nav.site.root', icon: 'GlobalOutlined', access: 'canVisitSite' },
  { path: '/site/settings', name: 'nav.site.settings', icon: 'SettingOutlined', access: 'canVisitSiteSettings' },
  { path: '/site/navigation', name: 'nav.site.navigation', icon: 'MenuOutlined', access: 'canVisitSiteNavigation' },
  { path: '/site/carousels', name: 'nav.site.carousels', icon: 'PictureOutlined', access: 'canVisitSiteCarousels' },
  { path: '/site/pages', name: 'nav.site.pages', icon: 'LayoutOutlined', access: 'canVisitSitePages' },
  ...
  { path: '/settings/ai-knowledge', name: 'nav.system.aiKnowledge', icon: 'FileSearchOutlined', access: 'canVisitAiKnowledge' },
...
export const backendRoutes: BackendRouteRecord[] = [
  ...
  { path: '/evaluations', component: '@/pages/evaluations', name: 'nav.evaluations.root', icon: 'StarOutlined', access: 'canVisitEvaluations' },
  {
    ...
    access: 'canVisitSite',
    routes: [
      { path: '/site', redirect: '/site/settings' },
      { path: '/site/settings', component: '@/pages/site/settings', name: 'nav.site.settings', icon: 'SettingOutlined', access: 'canVisitSiteSettings' },
      { path: '/site/navigation', component: '@/pages/site/navigation', name: 'nav.site.navigation', icon: 'MenuOutlined', access: 'canVisitSiteNavigation' },
      { path: '/site/carousels', component: '@/pages/site/carousels', name: 'nav.site.carousels', icon: 'PictureOutlined', access: 'canVisitSiteCarousels' },
      { path: '/site/pages', component: '@/pages/site/pages', name: 'nav.site.pages', icon: 'LayoutOutlined', access: 'canVisitSitePages' },
      { path: '/site/contents', component: '@/pages/site/contents', name: 'nav.site.contents', icon: 'ReadOutlined', access: 'canVisitSiteContents' },
      { path: '/site/forms', component: '@/pages/site/forms', name: 'nav.site.forms', icon: 'FormOutlined', access: 'canVisitSiteForms' },
      { path: '/site/submissions', component: '@/pages/site/submissions', name: 'nav.site.submissions', icon: 'InboxOutlined', access: 'canVisitSiteSubmissions' },
    ],
  },
  ...
  { path: '/user-center/files', component: '@/pages/files/Center', name: 'nav.files.my', icon: 'FileOutlined', access: 'canVisitSystemMyFiles' },
  {
    ...
    routes: [
      ...
      { path: '/settings/ai-knowledge', component: '@/pages/settings/ai-knowledge', name: 'nav.system.aiKnowledge', icon: 'FileSearchOutlined', access: 'canVisitAiKnowledge' },
