import { AppstoreOutlined, BuildOutlined, DatabaseOutlined, SettingOutlined, TeamOutlined, UserOutlined } from '@ant-design/icons';
...
export default () => {
  ...
  return (
    <ManagementPageContainer title="系统管理" description="平台管理导航页，所有核心管理能力从这里进入。">
      <Row gutter={[16, 16]}>
        <Col xs={24} md={8}>
          <Card>
