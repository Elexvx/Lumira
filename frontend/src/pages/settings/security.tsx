                ...
                children: (
                  <Space direction="vertical" size={16} style={{ width: '100%' }}>
                    <Form.Item
                      ...
                      rules={[{ required: true, message: formatMessage({ id: 'page.security.idleTimeout', defaultMessage: 'Please enter the idle timeout' }) }, { type: 'number', min: 1, message: formatMessage({ id: 'common.mustBeGreaterThanZero', defaultMessage: 'Must be greater than 0' }) }]}
                    ...
                    >
                      <InputNumber min={1} precision={0} style={{ width: '100%' }} placeholder={formatMessage({ id: 'page.security.example1800', defaultMessage: 'e.g. 1800' })} />
                    </Form.Item>
                    <Form.Item
                      ...
                      rules={[{ required: true, message: formatMessage({ id: 'page.security.accessTokenExpire', defaultMessage: 'Please enter the Access Token expiry time' }) }, { type: 'number', min: 1, message: formatMessage({ id: 'common.mustBeGreaterThanZero', defaultMessage: 'Must be greater than 0' }) }]}
                    ...
                    <Form.Item
                      ...
                      rules={[{ required: true, message: formatMessage({ id: 'page.security.refreshTokenExpire', defaultMessage: 'Please enter the Refresh Token expiry time' }) }, { type: 'number', min: 1, message: formatMessage({ id: 'common.mustBeGreaterThanZero', defaultMessage: 'Must be greater than 0' }) }]}
                    ...
                    >
                      <InputNumber min={1} precision={0} style={{ width: '100%' }} placeholder={formatMessage({ id: 'page.security.example604800', defaultMessage: 'e.g. 604800' })} />
                    </Form.Item>
                    <Form.Item
                ...
                children: (
                  <Space direction="vertical" size={16} style={{ width: '100%' }}>
                    <Form.Item
                      ...
                      rules={[{ required: true, message: formatMessage({ id: 'page.security.window', defaultMessage: 'Please enter the window size' }) }, { type: 'number', min: 1, message: formatMessage({ id: 'common.mustBeGreaterThanZero', defaultMessage: 'Must be greater than 0' }) }]}
                      extra={formatMessage({ id: 'page.security.window.help', defaultMessage: 'The time window used to track high-frequency access.' })}
                    >
                      <InputNumber min={1} precision={0} style={{ width: '100%' }} placeholder={formatMessage({ id: 'page.security.example5', defaultMessage: 'e.g. 5' })} />
                    </Form.Item>
                    <Form.Item
                      name="loginMaxValidationAttempts"
                      label={formatMessage({ id: 'page.security.maxAttempts', defaultMessage: 'Max validation attempts' })}
                      rules={[{ required: true, message: formatMessage({ id: 'page.security.maxAttempts', defaultMessage: 'Please enter the max validation attempts' }) }, { type: 'number', min: 1, message: formatMessage({ id: 'common.mustBeGreaterThanZero', defaultMessage: 'Must be greater than 0' }) }]}
                    ...
                    >
                      <InputNumber min={1} precision={0} style={{ width: '100%' }} placeholder={formatMessage({ id: 'page.security.example100', defaultMessage: 'e.g. 100' })} />
                    </Form.Item>
                    <Form.Item
                      name="loginMaxFailureCount"
                      label={formatMessage({ id: 'page.security.maxFailures', defaultMessage: 'Max failure count' })}
                      rules={[{ required: true, message: formatMessage({ id: 'page.security.maxFailures', defaultMessage: 'Please enter the max failure count' }) }, { type: 'number', min: 1, message: formatMessage({ id: 'common.mustBeGreaterThanZero', defaultMessage: 'Must be greater than 0' }) }]}
                ...
                children: (
                  <Space direction="vertical" size={16} style={{ width: '100%' }}>
                    <Form.Item
                      ...
                      rules={[{ required: true, message: formatMessage({ id: 'page.security.password.minLength', defaultMessage: 'Please enter the minimum length' }) }, { type: 'number', min: 1, message: formatMessage({ id: 'common.mustBeGreaterThanZero', defaultMessage: 'Must be greater than 0' }) }]}
                    ...
                    >
                      <InputNumber min={1} precision={0} style={{ width: '100%' }} placeholder={formatMessage({ id: 'page.security.example6', defaultMessage: 'e.g. 6' })} />
                    </Form.Item>
                    <Form.Item
