import { Button, DatePicker, Descriptions, Form, Input, Select, Space, Tag, Typography, message } from 'antd';
    ...
    >
      ...
      <ManagementDrawer
        ...
        footerActions={[
          ...
          { key: 'publish', label: '发布', type: 'primary', loading: publishing, onClick: () => void handlePublish() },
        ]}
      >
        <Form
          {...publishFormProps}
        ...
        >
          ...
          >
            <Input.TextArea rows={8} placeholder="请输入要发送给用户的站内信内容" />
          </Form.Item>
