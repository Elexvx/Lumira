...
- `services/auth-service`、`services/file-service`、`services/message-service`、`services/plugin-service`、`services/localization-service`、`services/job-executor`：后续拆分目标服务。审计能力目前仍归入 `backend/system-service` 的内部模块。
