...
- `docs/test-runs/2026-06-11-v0.1.0-rc1-test-checklist.md`
- `docs/test-runs/2026-06-18-v0.1.0-release-test-checklist.md`
...
| --- | --- | --- | --- | --- |
| AUTO-001 | `./mvnw test` |  |  |  |
| AUTO-002 | `./mvnw -pl services/system-service -am test` |  |  |  |
| AUTO-003 | `./mvnw -pl services/auth-service -am test` |  |  |  |
| AUTO-004 | `./mvnw -pl services/file-service -am test` |  |  |  |
| AUTO-005 | `./mvnw -pl services/message-service -am test` |  |  |  |
| AUTO-006 | `corepack pnpm --dir frontend test` |  |  |  |
| AUTO-007 | `corepack pnpm --dir frontend test:coverage` |  |  |  |
| AUTO-008 | `corepack pnpm --dir frontend test:smoke` |  |  |  |
| AUTO-009 | `node scripts/check-deployment.mjs` |  |  |  |
